...
public class DeclarationL extends DeclarationList {

    private DeclarationList DeclarationList;
    private Declaration Declaration;

    public DeclarationL (DeclarationList DeclarationList, Declaration Declaration) {
